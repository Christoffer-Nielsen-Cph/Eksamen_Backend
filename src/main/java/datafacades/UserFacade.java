...
public class UserFacade {
    ...
    public User createUser(User user) throws API_Exception {
        ...
        try {
            ...
            throw new API_Exception("There's already a user with the username: " + user.getUserName() + " in the system!",400,e);
        } finally {
            em.close();
        }
        return user;
    ...
    public User updateUser(User user) throws API_Exception {
        ...
        try {
            ...
            throw new API_Exception("Can't find a user with the username: "+user.getUserName(),404,e);
        } finally {
            em.close();
        }
    }
